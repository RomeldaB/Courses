...
matches to warp our images and create a better-looking panorama.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{output\PYZus{}shape}\PY{p}{,} \PY{n}{offset} \PY{o}{=} \PY{n}{get\PYZus{}output\PYZus{}space}\PY{p}{(}\PY{n}{img1}\PY{p}{,} \PY{p}{[}\PY{n}{img2}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{H}\PY{p}{]}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{merged} \PY{o}{=} \PY{n}{img1\PYZus{}warped} \PY{o}{+} \PY{n}{img2\PYZus{}warped}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Extract features from the corners}
         \PY{n}{desc1} \PY{o}{=} \PY{n}{describe\PYZus{}keypoints}\PY{p}{(}\PY{n}{img1}\PY{p}{,} \PY{n}{keypoints1}\PY{p}{,}
...
and produce our panorama.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{output\PYZus{}shape}\PY{p}{,} \PY{n}{offset} \PY{o}{=} \PY{n}{get\PYZus{}output\PYZus{}space}\PY{p}{(}\PY{n}{img1}\PY{p}{,} \PY{p}{[}\PY{n}{img2}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{H}\PY{p}{]}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{merged} \PY{o}{=} \PY{n}{img1\PYZus{}warped} \PY{o}{+} \PY{n}{img2\PYZus{}warped}
...
extra credit can be worth up to 1\% of your final grade.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{k+kn}{from} \PY{n+nn}{panorama} \PY{k}{import} \PY{n}{linear\PYZus{}blend}
